...
int main(){
	...
	l.pushFront(0);
	l.pushBack(2);
	cout << "Stage 1: "; for(size_t i = 0; i < l.size(); ++i, cout << " ") cout << l[i];; cout << endl;
	l.insert(1, 10);
	...
	l.removeBack();
	cout << "Stage 4: "; for(size_t i = 0; i < l.size(); ++i, cout << " ") cout << l[i];; cout << endl;
	l.removeFront();
	cout << "Stage 5: "; for(size_t i = 0; i < l.size(); ++i, cout << " ") cout << l[i];; cout << endl;
	return 0;
